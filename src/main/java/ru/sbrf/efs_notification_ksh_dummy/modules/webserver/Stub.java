...
public class Stub {
    ...
    public String response(String requestConv) {
        String s = null;

        switch (JsonPath.from(requestConv).get("query.dictionary").toString()) {
            ...
            case "RATE_QUOTE_ARK":
                if (JsonPath.from(requestConv).get("request.body.query.filter.compositeFilter.filters[0].propertyFilter.values[0]").toString().equalsIgnoreCase("75")) {
                    s = "true,\n" +
                            ...
                            "                        \"rowHeader\" :{\n" +
                            "                    \"attrs\" : [\n" +
                            "                    \"base\", \"bid\", \"elSign\", \"limitVol\", \"messageType\", \"offer\", \"protocol\", \"quoted\", \"reqDt\", \"scale\", \"scale\", \"seqNum\", \"startDate\", \"task_id\", \"tierCode\", \"tierVersion\", \"vol\" ]\n" +
                            "                },\n" +
                            "                \"rowDatas\" : [{\n" +
                            "                    \"values\" : [\"GBP\", [\"java.math.BigDecimal\", 10 ],\n" +
                            "                    \"\", null, \"UPDATE\", [\n" +
                            "                    \"java.math.BigDecimal\", 10 ],\"v1\", \"RUB\", [\"java.util.Date\", \"2019-12-25T14:23:56.000+0300\" ], [\n" +
                            "                    \"java.math.BigDecimal\", 1 ], [\"java.math.BigDecimal\", 1 ], [\"java.math.BigDecimal\", 19269 ], [\n" +
                            "                    \"java.util.Date\", \"2019-12-25T14:24:56.000+0300\" ],\n" +
                            "                    \"p7:261d87fc-8fe6-4f13-9115-16fec7c598c2\", \"75\", \"35\", [\"java.math.BigDecimal\", 0 ] ]\n" +
                            "                },{\n" +
                            "                    \"values\" : [\"GBP\", [\"java.math.BigDecimal\", 10 ],\n" +
                            "                    \"\", null, \"SNAPSHOT\", [\n" +
                            "                    \"java.math.BigDecimal\", 10 ],\"v1\", \"RUB\", [\"java.util.Date\", \"2019-12-24T17:07:22.000+0300\" ], [\n" +
                            "                    \"java.math.BigDecimal\", 1 ], [\"java.math.BigDecimal\", 1 ], [\"java.math.BigDecimal\", 19226 ], [\n" +
                            "                    \"java.util.Date\", \"2019-12-24T10:48:47.000+0300\" ],\n" +
                            "                    \"p7:9eb3c739-7b59-4dd7-bf3c-088f38131453\", \"75\", \"35\", [\"java.math.BigDecimal\", 0 ] ]\n" +
                            "                },{\n" +
                            "                    \"values\" : [\"GBP\", [\"java.math.BigDecimal\", 10 ],\n" +
                            "                    \"\", null, \"UPDATE\", [\n" +
                            "                    \"java.math.BigDecimal\", 10 ],\"v1\", \"RUB\", [\"java.util.Date\", \"2019-12-24T22:59:00.000+0300\" ], [\n" +
                            "                    \"java.math.BigDecimal\", 1 ], [\"java.math.BigDecimal\", 1 ], [\"java.math.BigDecimal\", 19239 ], [\n" +
                            "                    \"java.util.Date\", \"2019-12-24T23:00:00.000+0300\" ],\n" +
                            "                    \"p7:771d73a9-4a08-462d-baac-8143815278a0\", \"75\", \"35\", [\"java.math.BigDecimal\", 0 ] ]\n" +
                            "                } ]\n" +
                            "            }";
                } else {
                    s = "true,\n" +
                ...
                if (JsonPath.from(requestConv).get("request.body.query.filter.compositeFilter.filters[0].propertyFilter.values[0]").toString().equalsIgnoreCase("RUB")) {
                    ...
                    if (JsonPath.from(requestConv).get("request.body.query.resultAttrs[0]").toString().equalsIgnoreCase("cas_digit")) {
                        s = "true,\n" +
                                ...
                                "                        \"level\" :\"WARN\",\n" +
                                "                                \"message\" :\n" +
                                "                        \"Для подсистемы 'subsystem' запрещен доступ к справочнику 'CAS_E0_CURRENCY_NEW'\"\n" +
                                "                    } ],\n" +
                                "                    \"serverInfo\" :{\n" +
                                "                        \"distribVersion\" :\"D-03.003.00-2768\"\n" +
                                "                    },\n" +
